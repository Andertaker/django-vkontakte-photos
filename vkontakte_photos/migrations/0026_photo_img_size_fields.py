...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.rename_column('vkontakte_photos_photo', 'src_small', 'photo_75')
        db.rename_column('vkontakte_photos_photo', 'src', 'photo_130')
        db.rename_column('vkontakte_photos_photo', 'src_big', 'photo_604')
        db.rename_column('vkontakte_photos_photo', 'src_xbig', 'photo_807')
        db.rename_column('vkontakte_photos_photo', 'src_xxbig', 'photo_1280')
