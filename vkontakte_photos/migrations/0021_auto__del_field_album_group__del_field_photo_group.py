...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Album.group'
        db.delete_column(u'vkontakte_photos_album', 'group_id')

        # Deleting field 'Photo.group'
        db.delete_column(u'vkontakte_photos_photo', 'group_id')


    def backwards(self, orm):
        # Adding field 'Album.group'
        db.add_column(u'vkontakte_photos_album', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_albums', null=True, to=orm['vkontakte_groups.Group']),
                      keep_default=False)

        # Adding field 'Photo.group'
        db.add_column(u'vkontakte_photos_photo', 'group',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos', null=True, to=orm['vkontakte_groups.Group']),
                      keep_default=False)
