...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'vkontakte_photos_album', 'owner_id')

        # Adding field 'Album.owner_content_type'
        db.add_column(u'vkontakte_photos_album', 'owner_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'content_type_owners_vkontakte_photos_albums', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Album.owner_id'
        db.add_column(u'vkontakte_photos_album', 'owner_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, db_index=True),
                      keep_default=False)


        # Changing field 'Album.remote_id'
        db.alter_column(u'vkontakte_photos_album', 'remote_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))
        # Deleting field 'Photo.owner'
        db.delete_column(u'vkontakte_photos_photo', 'owner_id')

        # Adding field 'Photo.owner_content_type'
        db.add_column(u'vkontakte_photos_photo', 'owner_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'content_type_owners_vkontakte_photos_photos', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Photo.owner_id'
        db.add_column(u'vkontakte_photos_photo', 'owner_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, db_index=True),
                      keep_default=False)


        # Changing field 'Photo.remote_id'
        db.alter_column(u'vkontakte_photos_photo', 'remote_id', self.gf('django.db.models.fields.BigIntegerField')(primary_key=True))

    def backwards(self, orm):
        # Adding field 'Album.owner'
        db.add_column(u'vkontakte_photos_album', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='photo_albums', null=True, to=orm['vkontakte_users.User']),
                      keep_default=False)

        # Deleting field 'Album.owner_content_type'
        db.delete_column(u'vkontakte_photos_album', 'owner_content_type_id')

        # Deleting field 'Album.owner_id'
        db.delete_column(u'vkontakte_photos_album', 'owner_id')


        # Changing field 'Album.remote_id'
        db.alter_column(u'vkontakte_photos_album', 'remote_id', self.gf('django.db.models.fields.CharField')(max_length='20', unique=True))
        # Adding field 'Photo.owner'
        db.add_column(u'vkontakte_photos_photo', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='photos', null=True, to=orm['vkontakte_users.User']),
                      keep_default=False)

        # Deleting field 'Photo.owner_content_type'
        db.delete_column(u'vkontakte_photos_photo', 'owner_content_type_id')

        # Deleting field 'Photo.owner_id'
        db.delete_column(u'vkontakte_photos_photo', 'owner_id')


        # Changing field 'Photo.remote_id'
        db.alter_column(u'vkontakte_photos_photo', 'remote_id', self.gf('django.db.models.fields.CharField')(max_length='20', unique=True))
