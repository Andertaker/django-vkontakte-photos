...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.photo_2560'
        db.add_column(u'vkontakte_photos_photo', 'photo_2560',
                      self.gf('django.db.models.fields.CharField')(default='', max_length='200'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.photo_2560'
        db.delete_column(u'vkontakte_photos_photo', 'photo_2560')
